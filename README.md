...
Take the source TSV and produce a completed import TSV with these columns:
...
4. Let the toolkit canonicalize, validate, apply, and verify.

Future versions may add stronger provenance tracking, confidence flags, or assisted catalog lookup logic, but the current design intentionally keeps research and metadata writes separate.
